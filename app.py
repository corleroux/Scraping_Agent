...
def scrape_data(url):
    ...
    # crawl_url = "https://www.pnet.co.za/"
    # params = {
    #     "crawlerOptions": {
    #         "excludes": ["blog/*"],
    #         "includes": [
    #             "jobs/software-development-manager?action=facet_selected%3bworkFromHome%3b1&ag=age_1&wfh=1"
    #         ],  # leave empty for all pages
    #         "limit": 1,
    #     },
    #     "pageOptions": {"onlyMainContent": True},
    # }
    # scraped_data = app.crawl_url(
    #     crawl_url, params=params, wait_until_done=True, timeout=5
    # )
...
if __name__ == "__main__":
    ...
    # url = "http://autowash.co.za/services/edenvale/"
    # url = "https://www.pnet.co.za/jobs/software-development-manager?action=facet_selected%3bworkFromHome%3b1&ag=age_1&wfh=1"
